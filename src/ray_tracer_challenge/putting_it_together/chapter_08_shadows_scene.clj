...
(defn -main []
  (let [wall (sphere :transform (multiply-matrices (translation 0 0 5) (scaling 10 10 1))
        ...
        s3 (sphere :transform (multiply-matrices (translation -0.7 0.3 0.25)
                                                 (rotation-y (/ Math/PI 3))
                                                 (rotation-z (- (/ Math/PI 6)))
                                                 (scaling 0.45 0.1 0.4))
                   :material (material :color (color 0 0 1) :diffuse 0.7 :specular 0.3))
        s4 (sphere :transform (multiply-matrices (translation -1 0.7 0.5) (scaling 0.05 0.4 0.25))
                   :material (material :color (color 0 0 1) :diffuse 0.7 :specular 0.3))
        s5 (sphere :transform (multiply-matrices (translation -0.9 0.7 0.1)
                                                 (rotation-y (/ Math/PI 3))
                                                 (scaling 0.4 0.09 0.25))
                   :material (material :color (color 1 1 0) :diffuse 0.7 :specular 0.3))
        s6 (sphere :transform (multiply-matrices (translation -0.6 0.5 0.1)
                                                 (rotation-y (/ Math/PI 3))
                                                 (scaling 0.4 0.09 0.25))
                   :material (material :color (color 0 1 0) :diffuse 0.7 :specular 0.3))
        s7 (sphere :transform (multiply-matrices (translation -0.55 0.4 0.1)
                                                 (rotation-y (/ Math/PI 3))
                                                 (scaling 0.4 0.09 0.25))
                   :material (material :color (color 0 1 0) :diffuse 0.7 :specular 0.3))
