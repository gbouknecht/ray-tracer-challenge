  ...
  (let [material (material)
    ...
    (testing "should be able to handle eye between light and surface"
      (let [eye-vektor (vektor 0 0 -1)
            ...
            result (lighting material (sphere) light position eye-vektor normal-vektor false)]
    ...
    (testing "should be able to handle surface in shadow"
      (let [eye-vektor (vektor 0 0 -1)
            ...
            in-shadow true
            result (lighting material (sphere) light position eye-vektor normal-vektor in-shadow)]
        (is (roughly (color 0.1 0.1 0.1) result))))))
